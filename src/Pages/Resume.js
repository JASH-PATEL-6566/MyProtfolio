...
function Resume() {
    return (
        <BaseLayout>
            ...
            <Title symbol={""} title={"experience"} discription={"jksahdkash dkhasdk haksdh kahsdkj haskdh akshdk ahsdkh akjsdh kasdh"} />
            <AllExperience />
            ...
            <div className="d-flex flex-wrap gap-4 pt-5 align-items-center justify-content-center">
                ...
                <Image src='https://img.shields.io/badge/c++-%2300599C.svg?style=for-the-badge&logo=c%2B%2B&logoColor=white' title='JavaScript' />
