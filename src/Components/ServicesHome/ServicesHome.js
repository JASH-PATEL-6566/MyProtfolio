        ...
        <>
            ...
            <div className="d-flex flex-column align-items-center">
                <div className="w-100 all-border d-flex justify-content-center align-items-center mb-3 hover-yellow">
                    <OneTimeTypeAnimation size="vbig" text={"_web designer"} time={6} color={"blue"} />
                </div>
                <div className="w-100 all-border d-flex justify-content-center align-items-center mb-3 hover-yellow">
                    <OneTimeTypeAnimation size="vbig" text={"_back-end developer"} time={6} color={"sky-blue"} />
                </div>
                <div className="w-100 all-border d-flex justify-content-center align-items-center mb-3 hover-blue">
                    <OneTimeTypeAnimation size="vbig" text={"_full-stack developer"} time={6} color={"yellow"} />
                </div>
